...
const MajorCard = ({ title, icon: Icon, description, courses }) => (
    ...
    >
        <div className="w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center text-[#003A78] mb-6">
            <Icon size={28} />
        </div>
        ...
        <div className="space-y-4">
            <h4 className="font-bold text-[#003A78] text-sm uppercase tracking-wider">Example Courses</h4>
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    <div>
                        ...
                        <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">
                            GCS <span className="text-[#003A78]">Majors & Concentrations</span>
                        </h1>
                    </div>
            ...
            <main className="max-w-7xl mx-auto px-6 mt-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        className="bg-gradient-to-br from-[#003A78] to-[#002855] rounded-3xl p-8 text-white flex flex-col justify-center items-center text-center border-4 border-blue-400/30"
                    >
                        ...
                        <button className="bg-white text-[#003A78] px-8 py-3 rounded-full font-bold hover:bg-blue-50 transition-colors">
                            Propose a Major
                        </button>
                    </motion.div>
                </div>
